...
public class PhoneFactDoNotCallProjection implements java.io.Serializable {

	private static final long serialVersionUID = -2143483973;

	private final java.lang.Long    sequence;
	private final java.lang.Long    phoneId;
	private final java.lang.Boolean doNotCall;

	public PhoneFactDoNotCallProjection(

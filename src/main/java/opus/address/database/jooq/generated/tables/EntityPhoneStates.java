...
public class EntityPhoneStates extends org.jooq.impl.TableImpl<opus.address.database.jooq.generated.tables.records.EntityPhoneStates> {
	...
	private static final long serialVersionUID = 1798009935;
	...
	public java.util.List<org.jooq.ForeignKey<opus.address.database.jooq.generated.tables.records.EntityPhoneStates, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<opus.address.database.jooq.generated.tables.records.EntityPhoneStates, ?>>asList(opus.address.database.jooq.generated.Keys.ENTITY_PHONE_STATES__FK_ENTITY_PHONE_STATES_EVENTS, opus.address.database.jooq.generated.Keys.ENTITY_PHONE_STATES__FK_ENTITY_PHONE_STATES_ENTITIES, opus.address.database.jooq.generated.Keys.ENTITY_PHONE_STATES__FK_ENTITY_PHONE_STATES_PHONES);
	}

...
public class EntityAddressStates extends org.jooq.impl.TableImpl<opus.address.database.jooq.generated.tables.records.EntityAddressStates> {
	...
	private static final long serialVersionUID = 1856846692;
	...
	public java.util.List<org.jooq.ForeignKey<opus.address.database.jooq.generated.tables.records.EntityAddressStates, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<opus.address.database.jooq.generated.tables.records.EntityAddressStates, ?>>asList(opus.address.database.jooq.generated.Keys.ENTITY_ADDRESS_STATES__FK_ENTITY_ADDRESS_STATES_EVENTS, opus.address.database.jooq.generated.Keys.ENTITY_ADDRESS_STATES__FK_ENTITY_ADDRESS_STATES_ENTITIES, opus.address.database.jooq.generated.Keys.ENTITY_ADDRESS_STATES__FK_ENTITY_ADDRESS_STATES_ADDRESSES);
	}
